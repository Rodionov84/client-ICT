  ...
  return (
    <thead>
      <tr className="table-header-list-claims">
        ...
        {periods.map(period => {
          return <th onClick={() => setSelectedPeriod(period.num)} className="th-table-header" key={period.num}>
            <div className="th-img-block">
              <svg viewBox="0 0 122.87 122.88" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <th onClick={() => setSelectedPeriod(21)} title="более 20 дней со дня принятия заявления" className="th-table-header-21">
          <div className="th-img-block">
        ...
        <th onClick={() => setSelectedPeriod(1095)} title={"более 1095 дней, возможно превышение срока исковой давности"} className="th-table-header-1095">
